...
var news2landsat = require('../src/news2landsat.js');

function testSuccess(test) {
    return function (annotatedArticle) {
        test.done();
    }
};
...
function testFailure(test) {
    return function (e) {
        test.fail("news2landsat.news2landsat() is not supposed to fail with error: " + e.message);
        test.done();
    }
};
...
exports['news2landsat'] = function (test) {
    news2landsat.news2landsat("http://linuxfr.org", testSuccess(test), testFailure(test));
}

//exports['argumentPassingInPromisesChain'] = function(test){
//    promise_1 = news2landsat.boilerPipe.articleContent(/*with url = */"http://linuxfr.org")();
//    promise_1.then(
//        function(){
//            test.ok(news2landsat.boilerPipe.article);
//            to_promise_2 = news2landsat.clavin.resolveLocations(/*with text = */news2landsat.boilerPipe.article);
//            promise_2 = to_promise_2();
//            promise_2.then(function(){
//                test.ok(news2landsat.clavin.locations);
//                test.done()
//            })
//
//        }
...
//}
//
//exports['argumentPassingInPromisesChain2'] = function(test){
//    news2landsat.boilerPipe.articleContent(/*with url = */"http://linuxfr.org")()
//        .then(news2landsat.clavin.resolveLocations(/*with text = */news2landsat.boilerPipe.article))
//        .then(function(){
//            test.ok(news2landsat.boilerPipe.article);
//            test.ok(news2landsat.clavin.locations);
//            test.done()
